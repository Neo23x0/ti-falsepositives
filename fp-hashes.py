...
hash_whitelist = {
    ...
    "4096 bytes 0x00 - sometimes caused by an AV":
        ['620f0b67a91f7f74151bc5be745b7110',
        '1ceaf73df40e531df3bfb26b4fb7cd95fb7bff1d',
        'ad7facb2586fc6e966c004d7d1d16b024f5805ff7cb47c7a85dabd8b48892ca7'],
    "File filled with 99 zeros - sometimes caused by an AV":
...
if __name__ == '__main__':
    ...
    for byte in FP_BYTES:
        for i in range(8192):
            # Add to dictionary
            description = "Hashes of %d %s" % (i, str(byte))
            hash_whitelist[description] = []
            for hash in hashes:
                hash.update((b"%b" % byte) * i)
                hash_whitelist[description].append(hash.hexdigest())
